# feb/28/2021 11:25:14 by RouterOS 6.48.1
# software id = 
#
#
#
...
add mode=802.3ad name=bonding-IDF1-ACC-1P slaves=\
    sfpplus5<-IDF1-ACC-1P->sfpplus1,sfpplus6<-IDF1-ACC-1P->sfpplus2
add mode=802.3ad name=bonding-IDF2-ACC-1P slaves=\
    sfpplus7<-IDF2-ACC-1P->sfpplus1,sfpplus8<-IDF2-ACC-1P->sfpplus2
add mode=802.3ad name=bonding-IDF3-ACC-1P slaves=\
    sfpplus9<-IDF3-ACC-1P->sfpplus1,sfpplus10<-IDF3-ACC-1P->sfpplus2
add mode=802.3ad name=bonding-IDF4-ACC-1P slaves=\
    sfpplus11<-IDF4-ACC-1P->sfpplus1,sfpplus12<-IDF4-ACC-1P->sfpplus2
add mode=802.3ad name=bonding-MDF-ACC-1P slaves=\
    sfpplus1<-MDF-ACC-1P->sfpplus1,sfpplus2<-MDF-ACC-1P->sfpplus2
add mode=802.3ad name=bonding-MDF-ACC-2 slaves=\
    sfpplus3<-MDF-ACC-2->sfpplus1,sfpplus4<-MDF-ACC-2->sfpplus2
add mode=802.3ad name=bonding-MDF-AGG-2 slaves="qsfpplus1-1<-MDF-AGG-2->qsfppl\
...
add bridge=BR tagged="BR,bonding-MDF-RTR-1,bonding-MDF-RTR-2,bonding-MDF-AGG-2\
