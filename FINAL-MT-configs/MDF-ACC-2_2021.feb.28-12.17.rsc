# feb/28/2021 12:17:56 by RouterOS 6.48.1
# software id = 
#
#
#
...
set [ find default-name=ether9 ] disable-running-check=no disabled=yes
set [ find default-name=ether10 ] disable-running-check=no disabled=yes
...
add bridge=BR frame-types=admit-only-untagged-and-priority-tagged \
    ingress-filtering=yes interface=ether30 pvid=70
add bridge=BR frame-types=admit-only-vlan-tagged ingress-filtering=yes \
    interface=ether49-MGMT pvid=666
/ip neighbor discovery-settings
set discover-interface-list=!dynamic
/interface bridge vlan
add bridge=BR tagged=BR,bonding-MDF-AGG-1,bonding-MDF-AGG-2,ether49-MGMT \
    vlan-ids=2137
...
/ip address
add address=10.21.37.7/24 interface=VLAN2137-MGMT network=10.21.37.0
/ip dns
