# feb/21/2021 17:34:04 by RouterOS 6.48.1
# software id = 
#
#
#
...
/ip firewall filter
add action=passthrough chain=input comment=***LOCAL***
...
add action=accept chain=forward comment="NEW Printers to WAN" \
    connection-state=new disabled=yes out-interface-list=WAN src-address=\
    10.70.0.0/24
add action=accept chain=forward comment="!NEW Printers to WAN" \
...
add action=accept chain=forward comment="NEW Guest to WAN" connection-state=\
    new disabled=yes out-interface-list=WAN src-address=10.80.0.0/22
add action=accept chain=forward comment="!NEW Guest to WAN" connection-state=\
...
add action=accept chain=forward comment="NEW BYOD to WAN" connection-state=\
    new disabled=yes out-interface-list=WAN src-address=10.90.0.0/22
add action=accept chain=forward comment="!NEW BYOD to WAN" connection-state=\
...
add action=accept chain=forward comment="!NEW MGMT to Guest" \
    connection-state=established,related dst-address=10.80.0.0/22 \
    src-address=10.21.37.0/24
add action=accept chain=forward comment="!NEW MGMT to BYOD" connection-state=\
    established,related dst-address=10.90.0.0/22 src-address=10.21.37.0/24
add action=accept chain=forward comment="NEW MGMT to BYOD" connection-state=\
...
add action=accept chain=forward comment="!NEW MGMT to Company_1" \
    connection-state=established,related dst-address=10.100.0.0/23 \
    src-address=10.21.37.0/24
add action=accept chain=forward comment="NEW Printers to MGMT" \
    connection-state=new dst-address=10.21.37.0/24 src-address=10.70.0.0/24
add action=accept chain=forward comment="!NEW Printers to MGMT" \
    connection-state=established,related dst-address=10.21.37.0/24 \
    src-address=10.70.0.0/24
add action=accept chain=forward comment="NEW Printers to Guest" \
    connection-state=new disabled=yes dst-address=10.80.0.0/22 src-address=\
    10.70.0.0/22
add action=accept chain=forward comment="!NEW Printers to Guest" \
    connection-state=established,related disabled=yes dst-address=\
    10.80.0.0/22 src-address=10.70.0.0/22
add action=accept chain=forward comment="NEW Printers to BYOD" \
    connection-state=new disabled=yes dst-address=10.90.0.0/22 src-address=\
    10.70.0.0/24
add action=accept chain=forward comment="!NEW Printers to BYOD" \
    connection-state=established,related disabled=yes dst-address=\
    10.90.0.0/22 src-address=10.70.0.0/24
add action=accept chain=forward comment="NEW Printers to Company_1" \
    connection-state=new disabled=yes dst-address=10.100.0.0/23 src-address=\
    10.70.0.0/22
add action=accept chain=forward comment="!NEW Printers to Company_1" \
    connection-state=established,related disabled=yes dst-address=\
    10.100.0.0/23 src-address=10.70.0.0/22
add action=accept chain=forward comment="NEW Guest to MGMT" connection-state=\
    new dst-address=10.21.37.0/24 src-address=10.80.0.0/22
add action=accept chain=forward comment="!NEW Guest to MGMT" \
    connection-state=established,related dst-address=10.21.37.0/24 \
    src-address=10.80.0.0/22
add action=accept chain=forward comment="NEW Guest to Printers" \
    connection-state=new disabled=yes dst-address=10.70.0.0/24 src-address=\
    10.80.0.0/22
add action=accept chain=forward comment="!NEW Guest to Printers" \
    connection-state=established,related disabled=yes dst-address=\
    10.70.0.0/24 src-address=10.80.0.0/22
add action=accept chain=forward comment="NEW Guest to BYOD" connection-state=\
    new dst-address=10.90.0.0/22 src-address=10.80.0.0/22
add action=accept chain=forward comment="!NEW Guest to BYOD" \
    connection-state=established,related dst-address=10.90.0.0/22 \
    src-address=10.80.0.0/22
add action=accept chain=forward comment="NEW Guest to Company_1" \
    connection-state=new dst-address=10.100.0.0/23 src-address=10.80.0.0/22
add action=accept chain=forward comment="!NEW Guest to Company_1" \
    connection-state=established,related dst-address=10.100.0.0/23 \
    src-address=10.80.0.0/22
add action=accept chain=forward comment="NEW BYOD to MGMT" connection-state=\
    new dst-address=10.21.37.0/24 src-address=10.90.0.0/22
add action=accept chain=forward comment="!NEW BYOD to MGMT" connection-state=\
    established,related dst-address=10.21.37.0/24 src-address=10.90.0.0/22
add action=accept chain=forward comment="NEW BYOD to Printers" \
    connection-state=new disabled=yes dst-address=10.70.0.0/24 src-address=\
    10.90.0.0/22
add action=accept chain=forward comment="!NEW BYOD to Printers" \
    connection-state=established,related disabled=yes dst-address=\
    10.70.0.0/24 src-address=10.90.0.0/22
add action=accept chain=forward comment="NEW BYOD to Guest" connection-state=\
    new dst-address=10.80.0.0/22 src-address=10.90.0.0/22
add action=accept chain=forward comment="!NEW BYOD to Guest" \
    connection-state=established,related dst-address=10.80.0.0/22 \
    src-address=10.90.0.0/22
add action=accept chain=forward comment="NEW BYOD to Company_1" \
    connection-state=new dst-address=10.100.0.0/23 src-address=10.90.0.0/22
add action=accept chain=forward comment="!NEW BYOD to Company_1" \
    connection-state=established,related dst-address=10.100.0.0/23 \
    src-address=10.90.0.0/22
add action=accept chain=forward comment="NEW Company_1 to MGMT" \
    connection-state=new dst-address=10.21.37.0/24 src-address=10.100.0.0/23
add action=accept chain=forward comment="!NEW Company_1 to MGMT" \
    connection-state=established,related dst-address=10.21.37.0/24 \
    src-address=10.100.0.0/23
add action=accept chain=forward comment="NEW Company_1 to Printers" \
    connection-state=new disabled=yes dst-address=10.70.0.0/22 src-address=\
    10.100.0.0/23
add action=accept chain=forward comment="!NEW Company_1 to Printers" \
    connection-state=established,related disabled=yes dst-address=\
    10.70.0.0/22 src-address=10.100.0.0/23
add action=accept chain=forward comment="NEW Company_1 to BYOD" \
    connection-state=new dst-address=10.80.0.0/22 src-address=10.100.0.0/23
add action=accept chain=forward comment="!NEW Company_1 to BYOD" \
    connection-state=established,related dst-address=10.80.0.0/22 \
    src-address=10.100.0.0/23
add action=accept chain=forward comment="NEW Company_1 to Guest" \
    connection-state=new dst-address=10.90.0.0/22 src-address=10.100.0.0/23
add action=accept chain=forward comment="!NEW Company_1 to Guest" \
    connection-state=established,related dst-address=10.90.0.0/22 \
    src-address=10.100.0.0/23
